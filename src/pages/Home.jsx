            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 md:grid-cols-1 gap-4">
                <div className='bg-red-50 p-4 flex flex-row rounded-md  dark:bg-darkSubBg dark:hover:bg-darkBg transition duration-200 hover:shadow-lg hover:-translate-y-2 hover:bg-red-100'>
                    ...
                    <div className='pl-2'>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Develop robust full-stack web applications using MongoDB, Express, React, and Node.js. I handle both front-end and back-end development, ensuring seamless and dynamic user experiences for various applications.</p>
                    </div>
                </div>
                ...
                <div className='bg-purple-100 p-4 flex flex-row rounded-md dark:bg-darkSubBg dark:hover:bg-darkBg  transition duration-200 hover:shadow-lg hover:-translate-y-2 hover:bg-purple-200'>
                    ...
                    <div className='pl-2'>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Expertly create, customize, and manage WordPress websites. From designing unique themes to integrating essential plugins, I provide tailored solutions that meet diverse client needs and enhance website functionality.</p>
                    </div>
                </div>
                ...
                <div className='bg-purple-100 p-4 flex flex-row rounded-md dark:bg-darkSubBg dark:hover:bg-darkBg  transition duration-200 hover:shadow-lg hover:-translate-y-2 hover:bg-purple-200'>
                    ...
                    <div className='pl-2'>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Design and develop responsive, user-friendly websites using HTML, CSS, JavaScript, and Bootstrap. My approach combines aesthetic design with efficient coding practices to deliver visually appealing and highly functional web pages.</p>
                    </div>
                </div>
                ...
                <div className='bg-red-50 p-4 flex flex-row rounded-md dark:bg-darkSubBg dark:hover:bg-darkBg dark:text-darkText transition duration-200 hover:shadow-lg hover:-translate-y-2 hover:bg-red-100'>
                    ...
                    <div className='pl-2'>
                        ...
                        <p className="text-gray-600 dark:text-gray-400">Efficiently extract, process, and analyze data from various websites. Using advanced web scraping tools and techniques, I gather valuable insights and information, enabling data-driven decision-making for projects and businesses.</p>
                    </div>
                </div>
            </div>
            <div>
                    ...
                    <div className="">
                        <div className="flex space-x-8 w-full items-center justify-around animate-slide flex-wrap dark:rounded-lg">
                            <Link to={"https://logicexer.com/"} target="_blank" className="dark:bg-darkSubBg rounded p-2">
                                <img alt="Saran Zafar" className="h-20 " src="/public/img/webp/saran-zafar node-js.webp" />
                            </Link>
                            <Link to={"https://sspkotliajk.com/"} target="_blank" className="dark:bg-darkSubBg rounded p-2">
                                <img alt="Saran Zafar" className="h-20 " src="" />
                            </Link>
