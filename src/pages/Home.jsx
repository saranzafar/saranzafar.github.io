...
function Home() {
    ...
    return (
        <div className='text-secondary'>
            ...
            <div>
                <h2 className='text-2xl mt-10 font-semibold text-center'>Clients</h2>


                <div className="w-full px-4 pt-5 pb-16" id="faq">
                    <div className="">
                        <div className="flex space-x-8 w-full items-center justify-around animate-slide flex-wrap">
