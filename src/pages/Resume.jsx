            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 dark:bg-darkSubBg p-4 rounded-lg mt-10">
                ...
                <div className=''>
                    ...
                    <div className="flex justify-center flex-wrap gap-2 max-w-sm mx-auto my-4 text-sm">
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">SEO Optimization</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">Digital Marketing</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">Content Strategy</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">MERN Stack</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">WordPress</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">Web Development</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">Web Scraping</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">HTML</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">CSS</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">JavaScript</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">Bootstrap</button>
                        <button className="px-2 py-1 rounded dark:bg-secondary dark:text-darkText bg-gray-200/50 text-secondary hover:dark:bg-darkSubBg bg-gray-300">React</button>
                    </div>
