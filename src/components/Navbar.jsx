    ...
    return (
        <div className={`flex flex-col gap-3 ${className} ease-in-out`} id='myCustomNav'>
            <div className="group relative h-16 w-16">
                <NavLink to="/" end>
                    {({ isActive }) => (
                        <div className={`text-secondary group flex flex-col items-center p-2 hover:bg-purple-200 dark:hover:bg-darkBg hover:shadow-lg hover:-translate-y-1 ease-in-out transition duration-200 rounded-md shadow dark:text-darkHeading
