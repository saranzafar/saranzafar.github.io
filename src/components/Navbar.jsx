    ...
    return (
        ...
        <div className={`flex flex-col gap-2 ${className} ease-in-out`} id='myCustomNav'>
            <div className="group relative h-16 w-16">
                <Link to={"/"}>
                    <div className="text-secondary group flex flex-col items-center bg-gray-100 p-2 hover:bg-gray-200 hover:shadow-lg hover:-translate-y-1 ease-in-out dark:bg-darkSubBg dark:hover:bg-darkBg dark:text-darkHeading transition duration-200 rounded-md shadow">
